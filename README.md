...
#  version: branchName (e.g branch:master), latest release (e.g release:latest or tag:latest）,or (content:master:version.txt txt content is download url or version)
